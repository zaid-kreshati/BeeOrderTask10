...
class TasksController extends Controller
{
    ...
    {
        $task = $this->taskService->createTask($request->only('task_description', 'dead_line'));
        ...
        $lastPage=$this->taskService->lastPage();
    ...
    {
        $task = $this->taskService->updateTask($id, $request->only('task_description', 'dead_line','status'));
